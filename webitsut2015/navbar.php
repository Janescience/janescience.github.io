            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li>
                            <a href="admission.php?lang=th">การรับสมัคร</a>
                        </li>
                         <li>
                        ...
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">งานวิจัย<b class="caret"></b></a>
                            <ul class="dropdown-menu">
                                <li>
                                    <a href="papers.php?lang=th">งานวิจัย</a>
                                </li>
                                <li>
                                    <a href="articles.php?lang=th">บทความ</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="alumnai.php?lang=th">ศิษย์เก่า</a>
                        </li>
                    </ul>
                </div>
                <!-- /.navbar-collapse -->
