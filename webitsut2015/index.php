    ...
    <div class="container">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="hovereffect thumbnail">
                            <img class="img-responsive" src="images/bach_thumbnail.jpg" alt="">
                            <div class="overlay">
        ...
        <h3>ข่าวสารระดับปริญญาตรี</h3>
          <div class="media"> <!-- news 1 -->
            <div class="media-left">
              <img src="http://soctech.sut.ac.th/it/webitsut2015/images/pub_pic_major_tn.jpg" class="media-object" style="width:60px">
            </div>
            <div class="media-body">
              ...
              <a class="btn btn-info btn-xs" href="file/major_IT_2555_1_2558.pdf" role="button"> อ่านต่อ » </a>
            </div>
          </div>
          <div class="media"> <!-- news 1 -->
            <div class="media-left">
              <img src="http://soctech.sut.ac.th/it/webitsut2015/images/pub_pic_major_hp_tn.jpg" class="media-object" style="width:60px">
            </div>
            <div class="media-body">
          ...
          <div class="media"> <!-- news 1 -->
            <div class="media-left">
              <img src="http://soctech.sut.ac.th/it/webitsut2015/images/fund-02.png" class="media-object" style="width:60px">
            </div>
            <div class="media-body">
        ...
        <div class="col-md-4">
    		<h3>ข่าวสารระดับบัณฑิตศึกษา</h3>
              <div class="media"> <!-- news 1 -->
              <div class="media-left">
                <img src="images/doctornews1.jpg" class="media-object" style="width:60px">
              </div>
              <div class="media-body">
                <h4 class="media-heading">ขอเชิญผู้สนใจเข้าฟังการสอบป้องกันวิทยานิพนธ์ระดับปริญญาเอก</h4>
                <a class="btn btn-info btn-xs" href="https://www.facebook.com/ITSuranaree/photos/a.173365936026141.44193.122770094419059/1627525323943521/?type=3&theater" role="button"> อ่านต่อ » </a>
              </div>
            </div>
            <div class="media"> <!-- news 1 -->
              <div class="media-left">
                <img src="images/apply.jpg" class="media-object" style="width:60px">
              </div>
              <div class="media-body">
                <h4 class="media-heading">รับสมัครนักศึกษาระดับบัณฑิตศึกษา</h4>
                <a class="btn btn-info btn-xs" href="http://web.sut.ac.th/ces/?p=5132" role="button"> อ่านต่อ » </a>
              </div>
            </div>
             <!--<div class="media"> news 1 
              <div class="media-left">
